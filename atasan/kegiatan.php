		...
		<div class="layout-page">
			...
			<div class="content-wrapper">
				...
				<div class="container-xxl flex-grow-1 container-p-y">
					<!-- BreadCrumb -->
					<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi /</span> Disposisi Surat Agenda atau Kegiatan</h4>

					<div class="row">
						<div class="col-md-6 col-lg-4 col-xl-12 order-0 mb-4">
							<div class="card">
								<div class="card-header pb-3">
									<h4 class="mb-2 d-inline-block">Data Surat Kegiatan</h4>
								</div>
								<div class="card-body">
										...
										<table class="table table-striped table-hover table-fixed table-flush" id="table1" width="100%">
											<thead>
												<tr>
													...
													<th style="vertical-align: middle;" class="text-center">Nama Kegiatan</th>
													<th style="vertical-align: middle;" class="text-center">Dalam Rangka Kegiatan</th>
													<th style="vertical-align: middle;" class="text-center">Yang Membuat Rencana Kegiatan</th>
											...
											<tbody>
												...
												while ($data = mysqli_fetch_array($query)) { ?>
													<tr>
														...
														<td style="vertical-align: middle;" class="text-center"><?= $data['nama_kegiatan'] ?></td>
														<td style="vertical-align: middle;" class="text-center"><?= $data['tujuan_kegiatan']; ?></td>
														...
														<td style="vertical-align: middle;" class="text-center">
															<div class="btn-group" role="group">
																<button data-id="<?= $data['id_kegiatan']; ?>" onclick="isiIdKegiatan(this)" data-bs-toggle="modal" data-bs-target="#disposisiModal" type="button" title="Disposisi Surat Kegiatan" class="btn btn-sm btn-success d-flex align-items-center justify-content-center py-2">
																	<i class="fas fa-envelope-open-text fs-5"></i>
																</button>
																<a title="Detail Surat Kegiatan" href="detail_kegiatan.php?id_kegiatan=<?= $data['id_kegiatan']; ?>" class="btn btn-sm btn-info d-flex align-items-center justify-content-center py-2">
					...
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-header">
								<h1 class="modal-title fs-5" id="disposisiModalLabel">Disposisi Surat Agenda atau Kegiatan</h1>
							...
							<div class="modal-body">
								<form action="" method="POST">
									<div class="mb-3">
										...
										<input type="hidden" class="form-control" name="id_kegiatan" id="id_kegiatan" required>
									</div>
				...
				if (isset($_POST['tolak'])) {
					...
					$update = mysqli_query(
						...
						status_kegiatan = 'Data Ditolak Atasan' 
				...
				if (isset($_POST['setuju'])) {
					...
					$update = mysqli_query(
						...
						"UPDATE kegiatan SET 
						ket_kegiatan = '$ket_kegiatan',
						status_kegiatan = 'Disetujui Atasan' 
						WHERE kegiatan.id_kegiatan = $id_kegiatan;"
					);
				...
				<script>
					// script untuk mengisi input hidden id_kegiatan, ketika tombol disposisi diklik
					function isiIdKegiatan(e) {
						var dataId = e.getAttribute('data-id');
						var inputIdKegiatan = document.getElementById('id_kegiatan');
						inputIdKegiatan.value = dataId;
					}
				</script>