		...
		<div class="layout-page">
			...
			<div class="content-wrapper">
				...
				<div class="container-xxl flex-grow-1 container-p-y">
					<!-- BreadCrumb -->
					<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi /</span> Disposisi Surat Mutasi Pegawai</h4>

					<div class="row">
						<div class="col-md-6 col-lg-4 col-xl-12 order-0 mb-4">
							<div class="card">
								<div class="card-header pb-3">
									<h4 class="mb-2 d-inline-block">Data Mutasi Pegawai</h4>
								</div>
								<div class="card-body">
										...
										<table class="table table-striped table-hover table-fixed table-flush" id="table1" width="100%">
											<thead>
												<tr>
													...
													<th style="vertical-align: middle;" class="text-center">Nomor SK.</th>
													<th style="vertical-align: middle;" class="text-center">Tanggal SK. Mutasi</th>
													<th style="vertical-align: middle;" class="text-center">Tujuan</th>
													...
													<th style="vertical-align: middle;" class="text-center">Status Mutasi</th>
											...
											<tbody>
												...
												while ($data = mysqli_fetch_array($query)) { ?>
													<tr>
														...
														<td style="vertical-align: middle;" class="text-center text-nowrap"><?= $data['no_sk']; ?></td>
														<td style="vertical-align: middle;" class="text-center text-nowrap">
															<?= tgl_indo($data['tgl_sk']) ?>
														</td>
														<td style="vertical-align: middle;" class="text-center">
															<span style="display: block; width: 200px;"><?= $data['tujuan']; ?></span>
														</td>
														<td style="vertical-align: middle;" class="text-center">
															<span style="display: block; width: 200px;"><?= $data['new_jabatan']; ?></span>
														</td>
														<td style="vertical-align: middle;" class="text-center">
															<span style="display: block; width: 200px;"><?= $data['ket_mutasi']; ?></span>
														</td>
														<td style="vertical-align: middle;" class="text-center">
															<?php
															if ($data['status_mutasi'] == 'Sedang Diproses Atasan') {
																echo "<p class='badge rounded-pill bg-warning'><b>Sedang Diproses Atasan</b></p>";
															} else if ($data['status_mutasi'] == 'Disetujui Atasan') {
																echo "<p class='badge rounded-pill bg-success'><b>Disetujui Atasan</b></p>";
															} else if ($data['status_mutasi'] == "Data Ditolak Atasan") {
																echo "<p class='badge rounded-pill bg-danger'><b>Data Ditolak Atasan</b></p>";
															}
															?>
														</td>
														<td style="vertical-align: middle;" class="text-center">
															<div class="btn-group" role="group">
																<button data-id="<?= $data['id_mutasi']; ?>" onclick="isiIdMutasi(this)" data-bs-toggle="modal" data-bs-target="#disposisiModal" type="button" title="Disposisi Surat Mutasi" class="btn btn-sm btn-success d-flex align-items-center justify-content-center py-2">
																	<i class="fas fa-envelope-open-text fs-5"></i>
																</button>
																<a title="Detail Surat Mutasi" href="detail_mutasi.php?id_mutasi=<?= $data['id_mutasi']; ?>" class="btn btn-sm btn-info d-flex align-items-center justify-content-center py-2">
					...
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-header">
								<h1 class="modal-title fs-5" id="disposisiModalLabel">Disposisi Surat Mutasi Kegiatan</h1>
							...
							<div class="modal-body">
								<form action="" method="POST">
									<div class="mb-3">
										...
										<input type="hidden" class="form-control" name="id_mutasi" id="id_mutasi" required>
									</div>
				...
				if (isset($_POST['tolak'])) {
					...
					$ket_mutasi = $_POST['keterangan'];

					$update = mysqli_query(
						$koneksi,
						"UPDATE mutasi SET 
						ket_mutasi = '$ket_mutasi',
						status_mutasi = 'Data Ditolak Atasan' 
				...
				if (isset($_POST['setuju'])) {
					...
					$update = mysqli_query(
						...
						"UPDATE mutasi SET 
						ket_mutasi = '$ket_mutasi',
						status_mutasi = 'Disetujui Atasan' 
						WHERE mutasi.id_mutasi = $id_mutasi;"
					);
				...
				<script>
					// script untuk mengisi input hidden id_mutasi, ketika tombol disposisi diklik
					function isiIdMutasi(e) {
						var dataId = e.getAttribute('data-id');
						var inputIdMutasi = document.getElementById('id_mutasi');
						inputIdMutasi.value = dataId;
					}
				</script>