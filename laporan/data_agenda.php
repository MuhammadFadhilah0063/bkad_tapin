    ...
    <table class="">
      <tbody>
        ...
        <tr>
          ...
          <td>:</td>
          <td>
            <h5>Laporan Data Agenda / Kegiatan</h5>
          </td>
        </tr>
      </tbody>
    </table>
      ...
      <table class="table table-bordered table-hover table-sm" style="margin: 0 auto;" id="tableData">
        <thead class="">
          <tr class="text-center" style="background-color: beige;">
            ...
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Tanggal Kegiatan & Waktu Kegiatan</th>
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Nama & Lokasi Kegiatan</th>
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Tujuan Kegiatan</th>
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Yang Membuat Rencana</th>
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Keterangan Surat</th>
          </tr>
        </thead>
        <tbody>
          <?php
          ...
          if (isset($_POST['cetak'])) {
            ...
            $query = mysqli_query(
              ...
              WHERE MONTH(kegiatan.tgl_kegiatan) = $bulan
              AND YEAR(kegiatan.tgl_kegiatan) = $tahun
              ORDER BY kegiatan.tgl_kegiatan ASC"
            );
          } else {
            $query = mysqli_query(
              $koneksi,
