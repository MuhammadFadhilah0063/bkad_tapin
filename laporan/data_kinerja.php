  ...
  <div class="container" style="font-family: Times;"><br>
    ...
    <table class="">
      <tbody>
        ...
        <tr>
          ...
          <td>:</td>
          <td>
            <h5>Laporan Data Penilaian Kinerja Pegawai</h5>
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <div class="container">
      ...
      <table class="table table-bordered table-hover table-sm" style="margin: 0 auto;" id="tableData">
        <thead class="">
          <tr class="text-center" style="background-color: beige;">
            ...
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Jumlah Absen</th>
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Nilai</th>
          </tr>
        </thead>
        <tbody>
          <?php
          ...
          if (isset($_POST['cetak'])) {
            ...
            $query = mysqli_query(
              $koneksi,
              "SELECT absen_pegawai.id_pg, t_pegawai.nama_lengkap, t_pegawai.nip, 
              SUM(CASE WHEN absen_masuk IS NOT NULL AND absen_pulang IS NOT NULL THEN 1 ELSE 0 END) AS total_absen FROM absen_pegawai
              INNER JOIN t_pegawai ON absen_pegawai.id_pg=t_pegawai.id_pg
              WHERE MONTH(absen_pegawai.tanggal) = $bulan
              AND YEAR(absen_pegawai.tanggal) = $tahun
              GROUP BY absen_pegawai.id_pg"
            );
          }
      ...
      <div class="mt-3">
        ...
        <small class="">- Absen terhitung satu apabila, absen masuk dan absen pulang pada tanggal yang sama sudah dilakukan</small><br />
