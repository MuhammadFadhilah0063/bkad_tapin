...
<body>
  <div class="container" style="font-family: Times;"><br>
    ...
    <table class="">
      <tbody>
        ...
        <tr>
          ...
          <td>:</td>
          <td>
            <h5>Laporan Data Permohonan Cuti Pegawai</h5>
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <div class="container">
      <h2 class="text-center">DAFTAR PERMOHONAN CUTI PEGAWAI</h2>
      ...
      <table class="table table-bordered table-hover table-sm" style="margin: 0 auto;" id="tableData">
        <thead class="">
          <tr class="text-center" style="background-color: beige;">
            ...
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Tanggal Awal Cuti & Akhir Cuti</th>
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Total Hari Cuti</th>
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Keterangan Mengajukan Cuti</th>
        ...
        <tbody>
          ...
          if (isset($_POST['cetak'])) {
            ...
            $query = mysqli_query(
              ...
              WHERE MONTH(cuti.tgl_aw) = $bulan
              AND YEAR(cuti.tgl_aw) = $tahun
              ORDER BY cuti.tgl_aw ASC"
            );
          } else {
            $query = mysqli_query(
              $koneksi,
