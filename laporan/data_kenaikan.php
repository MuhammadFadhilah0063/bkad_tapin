    ...
    <table class="">
      <tbody>
        ...
        <tr>
          ...
          <td>:</td>
          <td>
            <h5>Laporan Data Kenaikan Jabatan Pegawai</h5>
          </td>
        </tr>
      </tbody>
    </table>
      ...
      <table class="table table-bordered table-hover table-sm" style="margin: 0 auto;" id="tableData">
        <thead class="">
          <tr class="text-center" style="background-color: beige;">
            ...
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Tanggal</th>
            ...
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Bidang</th>
        ...
        <tbody>
          ...
          if (isset($_POST['cetak'])) {
            ...
            $query = mysqli_query(
              ...
              WHERE MONTH(kenaikan_jabatan.tanggal) = $bulan
              AND YEAR(kenaikan_jabatan.tanggal) = $tahun
              ORDER BY kenaikan_jabatan.tanggal ASC"
            );
          } else {
            $query = mysqli_query(
              $koneksi,
