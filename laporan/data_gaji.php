    ...
    <table class="">
      <tbody>
        ...
        <tr>
          ...
          <td>:</td>
          <td>
            <h5>Laporan Data Gaji Pegawai</h5>
          </td>
        </tr>
      </tbody>
    </table>
      ...
      <table class="table table-bordered table-hover table-sm" style="margin: 0 auto;" id="tableData">
        <thead class="">
          <tr class="text-center" style="background-color: beige;">
            ...
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">No. Slip Gaji</th>
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Periode Gaji</th>
            ...
            <th style="vertical-align: middle; font-weight: bold; font-size: 13pt;">Gaji</th>
          </tr>
        </thead>
        <tbody>
          <?php
          ...
          if (isset($_POST['cetak'])) {
            ...
            $query = mysqli_query(
              ...
              WHERE gaji.bulan LIKE '%$bulan%' 
              AND gaji.tahun LIKE '%$tahun%'"
            );
          } else {
            $query = mysqli_query(
              $koneksi,
