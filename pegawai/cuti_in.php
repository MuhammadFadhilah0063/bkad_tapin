      ...
      <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <h4 class="fw-bold py-3 mb-4">
            ...
            <span class="text-muted fw-light">Pengajuan Cuti /</span>
            <span>Tambah</span>
          </h4>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card mb-4">
                <h5 class="card-header">Tambah Pengajuan Cuti Baru</h5>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="nama_lengkap" id="nama_lengkap" readonly value="<?= $user_row['nama_lengkap'] ?>" />
