		...
		<div class="layout-page">
			...
			<div class="content-wrapper">
				...
				<div class="container-xxl flex-grow-1 container-p-y">
					<!-- BreadCrumb -->
					<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi /</span> Kenaikan Jabatan</h4>

					<div class="row">
						<div class="col-md-6 col-lg-4 col-xl-12 order-0 mb-4">
							<div class="card">
								<div class="card-header pb-3">
									<h4 class="mb-2 d-inline-block">Data Kenaikan Jabatan Pegawai</h4>
									<a class="btn btn-primary ms-3" href="kenaikan_in.php">
										...
										<table class="table table-striped table-hover table-fixed table-flush" id="table1" width="100%">
											<thead>
												<tr>
													...
													<th style="vertical-align: middle;" class="text-center">No. Telpon</th>
													<th style="vertical-align: middle;" class="text-center">Golongan</th>
													<th style="vertical-align: middle;" class="text-center">Bidang</th>
											...
											<tbody>
												...
												$query = mysqli_query(
													$koneksi,
													"SELECT * FROM kenaikan_jabatan 
													INNER JOIN T_pegawai ON kenaikan_jabatan.nip = t_pegawai.nip
													ORDER BY id_kenaikan DESC"
												);
												...
												while ($data = mysqli_fetch_array($query)) { ?>
													<tr>
														...
														<td style="vertical-align: middle;" class="text-center">
															<span style="display: block; width: 150px;"><?= $data['bidang']; ?></span>
														</td>
														<td style="vertical-align: middle;" class="text-center">
															<span style="display: block; width: 200px;"><?= $data['bidang']; ?></span>
														</td>
														<td style="vertical-align: middle;" class="text-center">
															<div class="btn-group" role="group">
																<a title="Hapus Data Kenaikan Jabatan" href="kenaikan_hp.php?id_kenaikan=<?= $data['id_kenaikan']; ?>" class="btn btn-sm btn-danger d-flex align-items-center justify-content-center py-2" onClick="javascript: return confirm('Konfirmasi data akan dihapus?');">
