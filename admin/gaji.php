		...
		<div class="layout-page">
			...
			<div class="content-wrapper">
				...
				<div class="container-xxl flex-grow-1 container-p-y">
					<!-- BreadCrumb -->
					<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi /</span> Gaji</h4>

					<div class="row">
						<div class="col-md-6 col-lg-4 col-xl-12 order-0 mb-4">
							<div class="card">
								<div class="card-header pb-3">
									<h4 class="mb-2 d-inline-block">Data Gaji Pegawai</h4>
									<a class="btn btn-primary ms-3" href="gaji_in.php">
										...
										<table class="table table-striped table-hover table-fixed table-flush" id="table1" width="100%">
											<thead>
												<tr>
													...
													<th style="vertical-align: middle;" class="text-center">Periode Gaji</th>
													<th style="vertical-align: middle;" class="text-center">NIP</th>
													<th style="vertical-align: middle;" class="text-center">Nama</th>
													<th style="vertical-align: middle;" class="text-center">Gaji Bersih</th>
											...
											<tbody>
												...
												while ($data = mysqli_fetch_array($query)) { ?>
													<tr>
														...
														<td style="vertical-align: middle;" class="text-nowrap">
															<?= 'Rp. ' . number_format($data['gaji_bersih']); ?>
														</td>
														<td style="vertical-align: middle;" class="text-center">
															<div class="btn-group" role="group">
																<a title="Detail dan Cetak" href="detail_gaji.php?id_gaji=<?= $data['id_gaji']; ?>" class="btn btn-sm btn-info d-flex align-items-center justify-content-center py-2">
																	<i class="fas fa-info-circle fs-5"></i>
																</a>
																<a title="Hapus Data Gaji" href="gaji_hp.php?id_gaji=<?= $data['id_gaji']; ?>" class="btn btn-sm btn-danger d-flex align-items-center justify-content-center py-2" onClick="javascript: return confirm('Konfirmasi data akan dihapus?');">
