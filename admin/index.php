          ...
          <div class="row">
              ...
              <a href="absensi.php" class="card h-100 py-4 btn btn-light">
                <div class="card-body text-center d-flex justify-content-center align-items-center">
                  <span class="d-flex align-items-center">
                    ...
                    <span class="fs-4 text-dark fw-bold">Rekap Absensi</span>
                  </span>
                </div>
              </a>
            </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4">
              <a href="mutasi.php" class="card h-100 py-4 btn btn-light">
                <div class="card-body text-center d-flex justify-content-center align-items-center">
                  <span class="d-flex align-items-center">
                    <i class="fas fa-user-friends fs-1 text-dark me-3"></i>
                    <span class="fs-4 text-dark fw-bold">Mutasi Pegawai</span>
                  </span>
                </div>
              </a>
            </div>
              ...
              <a href="cuti.php" class="card h-100 py-4 btn btn-light">
                <div class="card-body text-center d-flex justify-content-center align-items-center">
                  <span class="d-flex align-items-center">
                    ...
                    <span class="fs-4 text-dark fw-bold">Cuti Pegawai</span>
                  </span>
                </div>
              </a>
            </div>
            <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4">
              <a href="agenda.php" class="card h-100 py-4 btn btn-light">
                <div class="card-body text-center d-flex justify-content-center align-items-center">
                  <span class="d-flex align-items-center">
                    <i class="fas fa-paste fs-1 text-dark me-3"></i>
                    <span class="fs-4 text-dark fw-bold">Agenda/Kegiatan</span>
                  </span>
                </div>
              </a>
            </div>
            <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4">
              <a href="pensiun.php" class="card h-100 py-4 btn btn-light">
                <div class="card-body text-center d-flex justify-content-center align-items-center">
                  <span class="d-flex align-items-center">
                    <i class="fas fa-briefcase fs-1 text-dark me-3"></i>
                    <span class="fs-4 text-dark fw-bold">Pensiun</span>
                  </span>
                </div>
              </a>
            </div>
            <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-4">
              <a href="kenaikan.php" class="card h-100 py-4 btn btn-light">
                <div class="card-body text-center d-flex justify-content-center align-items-center">
                  <span class="d-flex align-items-center">
                    <i class="fas fa-chart-line fs-1 text-dark me-3"></i>
                    <span class="fs-4 text-dark fw-bold">Kenaikan Jabatan</span>
                  </span>
                </div>
              </a>
            </div>
