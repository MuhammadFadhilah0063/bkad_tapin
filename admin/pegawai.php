		...
		<div class="layout-page">
			...
			<div class="content-wrapper">
				...
				<div class="container-xxl flex-grow-1 container-p-y">
					<!-- BreadCrumb -->
					<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data Master /</span> Pegawai</h4>

					<div class="row">
						<div class="col-md-6 col-lg-4 col-xl-12 order-0 mb-4">
							<div class="card">
								<div class="card-header pb-3">
									<h4 class="mb-2 d-inline-block">Data Pegawai</h4>
									<a class="btn btn-primary ms-3" href="pegawai_in.php">
											...
											<tbody>
												...
												while ($data = mysqli_fetch_array($sql)) { ?>
													<tr>
														...
														<td style="vertical-align: middle;" class="text-center">
															<span style="display: block; width: 200px;"><?= $data['nama_jabatan']; ?></span>
														</td>
														<td style="vertical-align: middle;" class="text-center">
															<?= $data['jenis_kelamin'] ?>
														</td>
														...
														<td style="vertical-align: middle;" class="text-center">
															<div class="btn-group" role="group">
																<a title="Detail Pegawai" href="detail_pegawai.php?id_pg=<?= $data['id_pg']; ?>" class="btn btn-sm btn-info d-flex align-items-center justify-content-center py-2">
																	<i class="fas fa-info-circle fs-5"></i>
																</a>
																<a title="Ubah Data Pegawai" href="pegawai_ed.php?id_pg=<?= $data['id_pg']; ?>" class="btn btn-sm btn-warning d-flex align-items-center justify-content-center py-2">
																	<i class="far fa-edit fs-5"></i>
																</a>
																<a title="Hapus Data Pegawai" href="pegawai_hp.php?id_pg=<?= $data['id_pg']; ?>" class="btn btn-sm btn-danger d-flex align-items-center justify-content-center py-2" onClick="javascript: return confirm('Konfirmasi data akan dihapus?');">
