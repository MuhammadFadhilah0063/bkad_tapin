        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card mb-4">
                <h5 class="card-header">Ubah Surat Mutasi Pegawai Baru</h5>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="no_sk" id="no_sk" value="<?= $row['no_sk']; ?>" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="tgl_sk" class="form-label">Tanggal SK Mutasi</label>
                        <input class="form-control" type="date" name="tgl_sk" id="tgl_sk" value="<?= $row['tgl_sk']; ?>" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="tujuan" class="form-label">Tujuan</label>
                        <input class="form-control" type="text" name="tujuan" id="tujuan" value="<?= $row['tujuan']; ?>" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="file_p" class="form-label">File Surat Pernyataan</label>
                        <input class="form-control" type="file" id="file_p" name="file_p" accept=".pdf" />
                      ...
                      <div class="mb-3 col-md-6">
                        ...
                        <select id="new_jabatan" name="new_jabatan" class="select2 form-select" required>
                          ...
                          ?>
                            <option value="<?= $rowJabatan['nama_jabatan'] ?>"
                            <?php if ($row['new_jabatan'] == $rowJabatan['nama_jabatan']) {
                              echo 'selected';
        ...
        if ($_FILES['file_p']['size'] != 0) {
          ...
          if ($ekstensi == 'pdf') {
            if ($ukuran <= 2048000) {
              ...
              $query = mysqli_query($koneksi, "SELECT file_p FROM mutasi WHERE id_mutasi = '$id_mutasi'");

              $row = mysqli_fetch_array($query);
              $filePath = '../assets/file/pernyataan/' . $row['file_p'];
