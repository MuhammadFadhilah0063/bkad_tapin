		...
		<div class="layout-page">
			...
			<div class="content-wrapper">
				...
				<div class="container-xxl flex-grow-1 container-p-y">
					<!-- BreadCrumb -->
					<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi /</span> Surat Agenda atau Kegiatan</h4>
						...
						<div class="col-md-6 col-lg-4 col-xl-12 order-0 mb-4">
							<div class="card">
								<div class="card-header pb-3">
									...
									<a class="btn btn-primary ms-3" href="agenda_in.php">
													...
													<tr>
														...
														<td style="vertical-align: middle;" class="text-center">
															<div class="btn-group" role="group">
																<a title="Detail Surat Kegiatan" href="detail_agenda.php?id_kegiatan=<?= $data['id_kegiatan']; ?>" class="btn btn-sm btn-info d-flex align-items-center justify-content-center py-2">
																	<i class="fas fa-info-circle fs-5"></i>
																</a>
																<a title="Ubah Data Surat Kegiatan" href="agenda_ed.php?id_kegiatan=<?= $data['id_kegiatan']; ?>" class="btn btn-sm btn-warning d-flex align-items-center justify-content-center py-2">
																	<i class="far fa-edit fs-5"></i>
																</a>
																<a title="Hapus Data Surat Kegiatan" href="agenda_hp.php?id_kegiatan=<?= $data['id_kegiatan']; ?>" class="btn btn-sm btn-danger d-flex align-items-center justify-content-center py-2" onClick="javascript: return confirm('Konfirmasi data akan dihapus?');">
