    ...
    <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card mb-4">
                <h5 class="card-header">Ubah Surat Kegiatan Baru</h5>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="nama_kegiatan" id="nama_kegiatan" value="<?= $row['nama_kegiatan'] ?>" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="lokasi_kegiatan" class="form-label">Lokasi Kegiatan</label>
                        <input class="form-control" type="text" name="lokasi_kegiatan" id="lokasi_kegiatan" value="<?= $row['lokasi_kegiatan'] ?>" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="tgl_kegiatan" class="form-label">Tanggal Kegiatan</label>
                        <input class="form-control" type="date" name="tgl_kegiatan" id="tgl_kegiatan" value="<?= $row['tgl_kegiatan'] ?>" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="waktu_kegiatan" class="form-label">Waktu kegiatan</label>
                        <input class="form-control" type="time" name="waktu_kegiatan" id="waktu_kegiatan" value="<?= $row['waktu_kegiatan'] ?>" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="tujuan_kegiatan" class="form-label">Tujuan Kegiatan</label>
                        <input list="option" class="form-control" type="text" name="tujuan_kegiatan" id="tujuan_kegiatan" value="<?= $row['tujuan_kegiatan'] ?>" required />
                        <datalist id="option">
                      ...
                      <div class="mb-3 col-md-6">
                        ...
                        <select name="nip" id="nip" class="select2 form-select">
                          ...
                          ?>
                            ...
                            <?php if ($row['nip'] == $rowPegawai['nip']) {
                              echo 'selected';
                            } ?>>
                            <?= $row['nip']; ?> | <?= $row['nama_lengkap']; ?>
                          </option>
                          <?php
                          }
                          ?>
      ...
      ?>
          <script>
            ...
            window.location = 'agenda_ed.php?id_kegiatan=<?= $id_kegiatan ?>';
          </script>
        <?php
        } else {
        ?>
