		...
		<div class="layout-page">
			...
			<div class="content-wrapper">
				...
				<div class="container-xxl flex-grow-1 container-p-y">
					<!-- BreadCrumb -->
					<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi /</span> Rekap Absensi</h4>

					<div class="row">
						<div class="col-md-6 col-lg-4 col-xl-12 order-0 mb-4">
							<div class="card">
								<div class="card-header pb-3">
									<h4 class="mb-2 d-inline-block">Data Rekap Absensi Pegawai</h4>
										...
										<table class="table table-striped table-hover table-fixed table-flush" id="table1" width="100%">
											<thead>
												<tr>
													...
													<th style="vertical-align: middle;" class="text-center">Bulan & Tahun</th>
													<th style="vertical-align: middle;" class="text-center">NIP</th>
													<th style="vertical-align: middle;" class="text-center">Nama Pegawai</th>
													<th style="vertical-align: middle;" class="text-center">Hadir</th>
													<th style="vertical-align: middle;" class="text-center">Sakit</th>
													<th style="vertical-align: middle;" class="text-center">Ijin</th>
													<th style="vertical-align: middle;" class="text-center">Tanpa Keterangan</th>
													<th style="vertical-align: middle;" class="text-center">Tanggal Sakit</th>
													<th style="vertical-align: middle;" class="text-center">Tanggal Izin</th>
													<th style="vertical-align: middle;" class="text-center">Tanggal Tanpa Keterangan</th>
													...
													<tr>
														...
														<td style="vertical-align: middle;" class="text-center">
															<div class="btn-group" role="group">
																<a title="Ubah Data Rekap Absensi" href="absensi_ed.php?id_absensi=<?= $data['id_absensi']; ?>" class="btn btn-sm btn-warning d-flex align-items-center justify-content-center py-2">
																	<i class="far fa-edit fs-5"></i>
																</a>
																<a title="Hapus Data Rekap Absensi" href="absensi_hp.php?id_absensi=<?= $data['id_absensi']; ?>" class="btn btn-sm btn-danger d-flex align-items-center justify-content-center py-2" onClick="javascript: return confirm('Konfirmasi data akan dihapus?');">
