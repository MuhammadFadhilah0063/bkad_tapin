    ...
    <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card mb-4">
                <h5 class="card-header">Ubah Data Pensiun</h5>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="nip" id="nip" value="<?= $row['nip'] ?>" required readonly />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="no_surat" class="form-label">No. Surat</label>
                        <input class="form-control" type="text" name="no_surat" id="no_surat" value="<?= $row['no_surat'] ?>" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="golongan" class="form-label">Golongan</label>
                        <input class="form-control" type="text" name="golongan" id="golongan" value="<?= $row['pangkat_gol'] ?>" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="tgl_surat" class="form-label">Tanggal Surat</label>
                        <input class="form-control" type="date" name="tgl_surat" id="tgl_surat" value="<?= $row['tgl_surat'] ?>" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="alamat" class="form-label">Alamat Pensiun</label>
                        <textarea class="form-control" name="alamat" id="alamat" rows="3" required><?= $row['alamat_pensiun'] ?></textarea>
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="tgl_pensiun" class="form-label">Tanggal Pensiun</label>
                        <input class="form-control" type="date" name="tgl_pensiun" id="tgl_pensiun" value="<?= $row['tgl_pensiun'] ?>" required />
                      </div>
                      <div class="mt-2">
      ...
      ?>
          <script>
            ...
            window.location = 'pensiun_ed.php?id_pensiun=<?= $id_pensiun ?>';
          </script>
        <?php
        } else {
        ?>
