						...
						<div class="col-md-6 col-lg-4 col-xl-12 order-0 mb-4">
							<div class="card">
								<div class="card-header pb-3">
									...
									<a class="btn btn-primary ms-3" href="jabatan_in.php">
												...
												<tr>
													...
													<td style="vertical-align: middle;" class="text-center">
														<div class="btn-group" role="group">
															<a title="Ubah Data Jabatan" href="jabatan_ed.php?id_jabatan=<?= $data['id_jabatan']; ?>" class="btn btn-sm btn-warning d-flex align-items-center justify-content-center py-2">
																<i class="far fa-edit fs-5"></i>
															</a>
															<a title="Hapus Data Jabatan" href="jabatan_hp.php?id_jabatan=<?= $data['id_jabatan']; ?>" class="btn btn-sm btn-danger d-flex align-items-center justify-content-center py-2" onClick="javascript: return confirm('Konfirmasi data akan dihapus?');">
