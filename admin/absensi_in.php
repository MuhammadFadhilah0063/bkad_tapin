  ...
  <div class="layout-container">
    ...
    <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card mb-4">
                <h5 class="card-header">Tambah Rekap Absensi Baru</h5>
                    ...
                    <div class="row">
                      ...
                      <div class="mb-3 col-md-6">
                        ...
                        <select name="id_pg" id="nip" class="select2 form-select">
                          ...
                          ?>
                            <option name="id_pg" value="<?= $row['id_pg']; ?>"><?= $row['nip']; ?> | <?= $row['nama_lengkap']; ?></option>
                          <?php
                          }
                          ?>
                        </select>
                      ...
                      <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="number" name="hadir" id="hadir" placeholder="0" value="0" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="sakit" class="form-label">Sakit</label>
                        <input class="form-control" type="number" name="sakit" id="sakit" placeholder="0" value="0" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="izin" class="form-label">Izin</label>
                        <input class="form-control" type="number" name="izin" id="izin" placeholder="0" value="0" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="tanpa_ket" class="form-label">Tanpa Keterangan</label>
                        <input class="form-control" type="number" name="tanpa_ket" id="tanpa_ket" placeholder="0" value="0" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="tgl_sakit" class="form-label">Tanggal Saat Sakit (tanggalnya saja)</label>
                        <input class="form-control" type="text" name="tgl_sakit" id="tgl_sakit" placeholder="-" value="-" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="tgl_ijin" class="form-label">Tanggal Saat Izin (tanggalnya saja)</label>
                        <input class="form-control" type="text" name="tgl_ijin" id="tgl_ijin" placeholder="-" value="-" required />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="tgl_tk" class="form-label">Tanggal Saat Tanpa Keterangan (tanggalnya saja)</label>
                        <input class="form-control" type="text" name="tgl_tk" id="tgl_tk" placeholder="-" value="-" required />
                      </div>
                      <div class="mt-2">
      ...
      if (isset($_POST['simpan'])) {
        ...
        $tambah = mysqli_query(
          $koneksi,
          "INSERT INTO absensi (tgl, bulan, tahun, id_pg, hadir, sakit, izin, tanpa_ket, tgl_sakit, tgl_ijin, tgl_tk) VALUES(
          '$tglSekarang',
          '$bulan',
          '$tahun',
          '$id_pg',
