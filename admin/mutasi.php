		...
		<div class="layout-page">
			...
			<div class="content-wrapper">
				...
				<div class="container-xxl flex-grow-1 container-p-y">
					<!-- BreadCrumb -->
					<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi /</span> Surat Mutasi Pegawai</h4>
						...
						<div class="col-md-6 col-lg-4 col-xl-12 order-0 mb-4">
							<div class="card">
								<div class="card-header pb-3">
									...
									<a class="btn btn-primary ms-3" href="mutasi_in.php">
											...
											<tbody>
												...
												while ($data = mysqli_fetch_array($query)) { ?>
													<tr>
														...
														<td style="vertical-align: middle;" class="text-center text-nowrap"><?= $data['nip'] ?></td>
														...
														<td style="vertical-align: middle;" class="text-center text-nowrap"><?= tgl_indo($data['tgl_sk']) ?></td>
														<td style="vertical-align: middle;" class="text-center">
														...
														<td style="vertical-align: middle;" class="text-center">
															<div class="btn-group" role="group">
																...
																<a title="Ubah Data Surat Mutasi" href="mutasi_ed.php?id_mutasi=<?= $data['id_mutasi']; ?>" class="btn btn-sm btn-warning d-flex align-items-center justify-content-center py-2">
																	<i class="far fa-edit fs-5"></i>
																</a>
																<a title="Hapus Data Surat Mutasi" href="mutasi_hp.php?id_mutasi=<?= $data['id_mutasi']; ?>" class="btn btn-sm btn-danger d-flex align-items-center justify-content-center py-2" onClick="javascript: return confirm('Konfirmasi data akan dihapus?');">
