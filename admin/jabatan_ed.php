    ...
    <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card mb-4">
                <h5 class="card-header">Ubah Data Jabatan</h5>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="nama_jabatan" name="nama_jabatan" placeholder="Nama Jabatan" value="<?= $row['nama_jabatan'] ?>" />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="gajipok" class="form-label">Gaji Pokok</label>
                        <input class="form-control" type="number" name="gajipok" id="gajipok" placeholder="Gaji Pokok" value="<?= $row['gajipok'] ?>" />
                      </div>
                      <div class="mb-3 col-md-6">
                        <label for="tunjangan" class="form-label">Tunjangan</label>
                        <input class="form-control" type="number" name="tunjangan" id="tunjangan" placeholder="Tunjangan" value="<?= $row['tunjangan'] ?>" />
                      </div>
                      <div class="mt-2">
      ...
      ?>
          <script>
            ...
            window.location = 'jabatan_ed.php?id_jabatan=<?= $id_jabatan ?>';
          </script>
        <?php
        } else {
        ?>
